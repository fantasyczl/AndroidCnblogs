...
public class Blog {
    ...
    public void setAddTime(String str) {
        _addTime = TimeTools.parseDate(str);
    }
    ...
    public void setUpdateTime(String str) {
        _updateTime = TimeTools.parseDate(str);
    }
    ...
    public void setIsFullText(String str) {
        _isFullText = (!TextUtils.isEmpty(str)) && "1".equals(str);
    }
    ...
    public void setIsReaded(String str) {
        _isReaded = (!TextUtils.isEmpty(str)) && "1".equals(str);
    }
