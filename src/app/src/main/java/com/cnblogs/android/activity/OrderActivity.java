...
public class OrderActivity extends BaseActivity {
	...
	void InitialControls() {
		...
		SimpleAdapter adapter = new SimpleAdapter(this, getData(),
				R.layout.order_list_item, new String[] { "PIC", "TITLE",
						"DESC", "TAG" }, new int[] { R.id.more_tools_icon,
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				EnumActivityType.EnumOrderActivityType activityType = EnumActivityType.EnumOrderActivityType
						.values()[type];
	...
	private List<Map<String, Object>> getData() {
		Integer[] images = { R.drawable.myspace, R.drawable.ember,
				R.drawable.digg_this, R.drawable.geotag };
		String[] texts = { "推荐博客排名", "48小时阅读排行", "10天内推荐排行", "推荐新闻" };
		String[] descs = { "按园友推荐的次数进行排名，均是园子里较有影响力的作者。",
				"在过去48小时内被阅读次数最多的博客排行。", "10天内被园友推荐次数最多的博客排行，代表了近期园子里最受欢迎的博客。",
				"博客园新闻编辑人工精选，近期最值得阅读的新闻资讯。" };
		EnumActivityType.EnumOrderActivityType[] tags = {
				EnumActivityType.EnumOrderActivityType.RecommendBlog,
