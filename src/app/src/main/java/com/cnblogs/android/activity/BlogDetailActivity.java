...
public class BlogDetailActivity extends BaseActivity implements OnGestureListener {
    ...
    void initTitleBar() {
        ...
        blog_button_back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
    ...
    void initWebView() {
        try {
            mWebView = (WebView) findViewById(R.id.blog_body_webview_content);
...
//    		mWebView.addJavascriptInterface(this, "javatojs");
            ...
            float webviewScale = sharePreferencesSettings.getFloat(
                    res.getString(R.string.preferences_webview_zoom_scale), 1.0f);
...
//            mWebView.setInitialScale(scalePercent);
    ...
    public void onDestroy() {
        float webviewScale = mWebView.getScale();
        sharePreferencesSettings
                .edit()
                .putFloat(
